...
5. Set **Check type** to **HTTP**, give the **Job a Name**, Put http://grafanalive.krummysolutions.com:3389/shop?name=User as the **target**, select any **probe locations** you'd like (I'd recommend doing >3), and select **Save**
   - For a more interesting probe set up another one with http://grafanalive.krummysolutions.com:3389/cart?name=Jim&checkout=true
   - If you want to do a traceroute use grafanalive.krummysolutions.com
